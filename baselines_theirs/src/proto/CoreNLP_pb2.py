...
_SENTENCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='paragraph', full_name='edu.stanford.nlp.pipeline.Sentence.paragraph', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='text', full_name='edu.stanford.nlp.pipeline.Sentence.text', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hasRelationAnnotations', full_name='edu.stanford.nlp.pipeline.Sentence.hasRelationAnnotations', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='entity', full_name='edu.stanford.nlp.pipeline.Sentence.entity', index=21,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='relation', full_name='edu.stanford.nlp.pipeline.Sentence.relation', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hasNumerizedTokensAnnotation', full_name='edu.stanford.nlp.pipeline.Sentence.hasNumerizedTokensAnnotation', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mentions', full_name='edu.stanford.nlp.pipeline.Sentence.mentions', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mentionsForCoref', full_name='edu.stanford.nlp.pipeline.Sentence.mentionsForCoref', index=25,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hasCorefMentionsAnnotation', full_name='edu.stanford.nlp.pipeline.Sentence.hasCorefMentionsAnnotation', index=26,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sentenceID', full_name='edu.stanford.nlp.pipeline.Sentence.sentenceID', index=27,
